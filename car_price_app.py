...
st.title("Prediksi penjualan kendaraan bermotor bekas dengan menggunakan Random Forest")

# Additional text below the header
st.write("aplikasi untuk memprediksi harga kendaraan bermotor bekas berdasarkan beberapa parameter dan nilai dari pasar")
...
present_price = st.number_input("Present Price (harga kendaraan bermotor baru (IDR Juta))")
...
if st.button("Predict"):
    ...
    st.subheader("Total Harga Jual [IDR Juta]")
    st.write(result[0])
